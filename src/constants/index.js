...
export const DESKTOP_TEXT = [
    ...
    'Creativity is intelligence having fun.', 'Sky is the limit', 'We May Encounter Many Defeats But We Must Not Be Defeated.', 'Hold the vision, trust the process.', 'The hard days are what make you stronger.',

...
export const DESKTOP_TEXT = [
    ...
    'Creativity is intelligence having fun.', 'Sky is the limit', 'If you believe it will work out, you’ll see opportunities. If you believe it won’t, you will see obstacles.', 'Hold the vision, trust the process.', 'The hard days are what make you stronger.',
